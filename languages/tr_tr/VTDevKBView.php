...
$languageStrings = array(
    'LBL_CONFIGURE_KANBAN_VIEW' =>'Configure VTDevKBView',
    ...
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'No configuration is needed. VTDevKBView option has been added to every list in the system. Open the list of records, click More > VTDevKBView. You will then be able to configure each list.<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension .',
);
