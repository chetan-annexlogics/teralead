<?php /* Smarty version Smarty-3.1.7, created on 2024-01-03 14:20:57
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/step3.tpl" */ ?>
<?php /*%%SmartyHeaderCode:169781397465956d4993ba79-38876213%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17861da481fec162e5ae3a5be7cd99a1b4bcf3da' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/step3.tpl',
      1 => 1704289893,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169781397465956d4993ba79-38876213',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_65956d499732d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_65956d499732d')) {function content_65956d499732d($_smarty_tpl) {?>
...
' /><input type="hidden" name="selected_calculation_fields"  value='<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('calculation_fields');?>
' /><input type="hidden" name="rename_columns" value='<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('rename_columns');?>
...
</strong></h4><br><span class="col-lg-6" style="margin-bottom: 10px"><button type="button" class="button-header-vreport" name="addgroup"><i class="fa fa-plus-circle"></i><strong>  <?php echo vtranslate('ADD_GROUP',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong>&nbsp;&nbsp;</button></span><div id="conditionClone" style="display: none"><div class="button-action" style="margin: 20px auto; width: 200px; display: inherit"><select class="group-condition" style="height: 30px;width: 70px"><option value="or"><?php echo vtranslate('LBL_OR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</div><span class="col-lg-12" id="filter_conditions"><?php if (count($_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELDS']->value)>0){?><?php  $_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELD']->_loop = false;
...
<?php }?></span></div></div><br><div class="modal-overlay-footer border1px clearfix"><div class="row clearfix"><div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 "><button type="button" class="btn btn-danger backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
