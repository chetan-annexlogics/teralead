<?php /* Smarty version Smarty-3.1.7, created on 2024-01-03 14:19:59
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44132026565956d0f3a7ac1-51935410%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '54e84727e17b929e58c5f6d678442dfc831b74d4' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/step2.tpl',
      1 => 1704289893,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44132026565956d0f3a7ac1-51935410',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'fieldNameArray' => 0,
    'columnName' => 0,
    'SELECTED_CALCULATION_FIELDS_RENAME_COLUMNS' => 0,
    'RENAME_STATUS' => 0,
  ...
  'unifunc' => 'content_65956d0f40ca1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_65956d0f40ca1')) {function content_65956d0f40ca1($_smarty_tpl) {?>
...
'><input type="hidden" name="specificemails" value="<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('specificemails');?>
"><input type="hidden" name="from_address" value="<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('from_address');?>
...
</label><select data-placeholder="<?php echo vtranslate('LBL_ADD_MORE_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></div><div class="padding1per"><table class="table table-bordered CalculationFields" width="100%"><thead><tr class="calculationHeaders blockHeader"><th><?php echo vtranslate('LBL_RENAME_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</th><th><?php echo vtranslate('LBL_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?><?php $_smarty_tpl->tpl_vars['FIELD_EXPLODE'] = new Smarty_variable(explode(':',$_smarty_tpl->tpl_vars['CALCULATION_FIELD_KEY']->value), null, 0);?><?php $_smarty_tpl->tpl_vars['tableName'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_EXPLODE']->value['0'], null, 0);?><?php $_smarty_tpl->tpl_vars['columnName'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_EXPLODE']->value['1'], null, 0);?><?php $_smarty_tpl->tpl_vars['FIELDNAME_EXPLODE'] = new Smarty_variable(explode('_',$_smarty_tpl->tpl_vars['FIELD_EXPLODE']->value['2']), null, 0);?><?php $_smarty_tpl->tpl_vars['fieldNameArray'] = new Smarty_variable(array_slice($_smarty_tpl->tpl_vars['FIELDNAME_EXPLODE']->value,1), null, 0);?><?php $_smarty_tpl->tpl_vars['fieldName'] = new Smarty_variable(implode('_',$_smarty_tpl->tpl_vars['fieldNameArray']->value), null, 0);?><?php $_smarty_tpl->tpl_vars['RENAME_STATUS'] = new Smarty_variable($_smarty_tpl->tpl_vars['SELECTED_CALCULATION_FIELDS_RENAME_COLUMNS']->value[$_smarty_tpl->tpl_vars['columnName']->value]['rename_status'], null, 0);?><?php $_smarty_tpl->tpl_vars['RENAME_COLUMN'] = new Smarty_variable($_smarty_tpl->tpl_vars['SELECTED_CALCULATION_FIELDS_RENAME_COLUMNS']->value[$_smarty_tpl->tpl_vars['columnName']->value]['rename'], null, 0);?><tr class="calculationFieldRow"><td width="5%"><input class="calculationType" name="rename_columns_selected[<?php echo $_smarty_tpl->tpl_vars['columnName']->value;?>
]" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['RENAME_STATUS']->value==true){?> checked="" <?php }?> value="true"/></td><td><span class="default-columns-name" <?php if ($_smarty_tpl->tpl_vars['RENAME_STATUS']->value==true){?> style="display: none" <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['CALCULATION_FIELDS_MODULE_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span><input type="text" class="inputElement" name="rename_columns[<?php echo $_smarty_tpl->tpl_vars['columnName']->value;?>
]" value="<?php if (!empty($_smarty_tpl->tpl_vars['RENAME_COLUMN']->value)){?> <?php echo $_smarty_tpl->tpl_vars['RENAME_COLUMN']->value;?>
 <?php }else{ ?> <?php echo vtranslate($_smarty_tpl->tpl_vars['CALCULATION_FIELDS_MODULE_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
-<?php echo vtranslate($_smarty_tpl->tpl_vars['CALCULATION_FIELD']->value,$_smarty_tpl->tpl_vars['CALCULATION_FIELDS_MODULE_LABEL']->value);?>
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['RENAME_STATUS']->value!=true){?> style="display: none"<?php }?>></td><?php  $_smarty_tpl->tpl_vars['FIELD_OPERATION_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_OPERATION_VALUE']->_loop = false;
