<?php /* Smarty version Smarty-3.1.7, created on 2024-01-06 06:32:23
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VTDevKBView/QuickEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:574267588657c408e8b3296-74333147%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0860490a37bc1d90119938dfd7d590f89e4095f9' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VTDevKBView/QuickEdit.tpl',
      1 => 1704521288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '574267588657c408e8b3296-74333147',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_657c408e93c3d',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_657c408e93c3d')) {function content_657c408e93c3d($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['jsModel'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['jsModel']->_loop = false;
...
' /><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Events'){?><input type="hidden" name="source_module" value="Calendar"><?php }else{ ?><input type="hidden" name="source_module" value="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
"><?php }?><input type="hidden" name="module" value="VTDevKBView"><input type="hidden" name="action" value="QuickAjax"><input type="hidden" name="record" value="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value;?>
"><div class="quickCreateContent"><table class="massEditTable table no-border"><tr><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
...
</td><?php }?><?php } ?></tr><?php if ($_smarty_tpl->tpl_vars['PRIMARY_FIELD_NAME']->value){?><tr><td class='fieldLabel col-lg-2'><label class="muted pull-right"><?php echo vtranslate($_smarty_tpl->tpl_vars['PRIMARY_FIELD_NAME']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;</label></td><td class="fieldValue col-lg-4"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['PRIMARY_FIELD_NAME']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('FIELD_MODEL'=>$_smarty_tpl->tpl_vars['PRIMARY_FIELD_NAME']->value), 0);?>
</td></tr><?php }?></table></div></div><div class="modal-footer"><center><?php if ($_smarty_tpl->tpl_vars['BUTTON_NAME']->value!=null){?><?php $_smarty_tpl->tpl_vars['BUTTON_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['BUTTON_NAME']->value, null, 0);?><?php }else{ ?><?php ob_start();?><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
