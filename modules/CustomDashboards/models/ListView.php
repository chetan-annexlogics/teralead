 ...
 */
class CustomDashboards_ListView_Model extends Vtiger_ListView_Model
{
    /**
    ...
    public function getListViewMassActions()
    {
        ...
        if ($currentUserModel->hasModulePermission($this->getModule()->getId())) {
            $massActionLinks[] = array("linktype" => "LISTVIEWMASSACTION", "linklabel" => "LBL_DELETE", "linkurl" => "javascript:CustomDashboards_List_Js.massDelete(\"index.php?module=" . $this->getModule()->get("name") . "&action=MassDelete\");", "linkicon" => "");
            $massActionLinks[] = array("linktype" => "LISTVIEWMASSACTION", "linklabel" => "LBL_MOVE_REPORT", "linkurl" => "javascript:CustomDashboards_List_Js.massMove(\"index.php?module=" . $this->getModule()->get("name") . "&view=MoveReports\");", "linkicon" => "");
        }
    ...
    public function getListViewEntries($pagingModel)
    {
        ...
        $reportRecordModels = $reportFolderModel->getCustomDashboards($pagingModel);
    ...
    public function getListViewCount()
    {
        ...
        return $reportFolderModel->getCustomDashboardsCount();
    }
    public function getCreateRecordUrl()
    {
        return "javascript:CustomDashboards_List_Js.addReport(\"" . $this->getModule()->getCreateRecordUrl() . "\")";
    }
}
