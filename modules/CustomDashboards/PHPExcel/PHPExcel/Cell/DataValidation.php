...
class PHPExcel_Cell_DataValidation
{
     ...
     * @var string
     */
    private $formula1 = NULL;
    /**
     * Formula 2
     *
     * @var string
     */
    private $formula2 = NULL;
    /**
     * Type
     *
     * @var string
     ...
     * @var boolean
     */
    private $allowBlank = NULL;
    /**
     * Show DropDown
     *
     * @var boolean
     */
    private $showDropDown = NULL;
    /**
     * Show InputMessage
     *
     * @var boolean
     */
    private $showInputMessage = NULL;
    /**
     * Show ErrorMessage
     *
     * @var boolean
     */
    private $showErrorMessage = NULL;
    /**
     * Error title
     *
     * @var string
    ...
    {
        return md5($this->formula1 . $this->formula2 . ($this->type = PHPExcel_Cell_DataValidation::TYPE_NONE . ($this->errorStyle = PHPExcel_Cell_DataValidation::STYLE_STOP . $this->operator . ($this->allowBlank ? "t" : "f") . ($this->showDropDown ? "t" : "f") . ($this->showInputMessage ? "t" : "f") . ($this->showErrorMessage ? "t" : "f") . $this->errorTitle . $this->error . $this->promptTitle . $this->prompt . "PHPExcel_Cell_DataValidation")));
    }
    /**
