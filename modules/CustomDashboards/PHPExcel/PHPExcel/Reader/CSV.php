...
class PHPExcel_Reader_CSV extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    protected function skipBOM()
    {
        ...
        switch ($this->inputEncoding) {
            case "UTF-8":
                fgets($this->fileHandle, 4);
                fgets($this->fileHandle, 4) == "ï»¿" ? fseek($this->fileHandle, 3) : fseek($this->fileHandle, 0);
                break;
            case "UTF-16LE":
                fgets($this->fileHandle, 3);
                fgets($this->fileHandle, 3) == "ÿþ" ? fseek($this->fileHandle, 2) : fseek($this->fileHandle, 0);
                break;
            case "UTF-16BE":
                fgets($this->fileHandle, 3);
                fgets($this->fileHandle, 3) == "þÿ" ? fseek($this->fileHandle, 2) : fseek($this->fileHandle, 0);
                break;
            case "UTF-32LE":
                fgets($this->fileHandle, 5);
                fgets($this->fileHandle, 5) == "ÿþ" ? fseek($this->fileHandle, 4) : fseek($this->fileHandle, 0);
                break;
            case "UTF-32BE":
                fgets($this->fileHandle, 5);
                fgets($this->fileHandle, 5) == "" ? fseek($this->fileHandle, 4) : fseek($this->fileHandle, 0);
                break;
            default:
                break;
        }
