...
class PHPExcel_Reader_Gnumeric extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
    {
        ...
        if (isset($namespacesMeta["office"])) {
            ...
            $officeDocXML = $officeXML->_obfuscated_646F63756D656E742D6D657461_;
            ...
            if (isset($gnmXML->Summary)) {
                foreach ($gnmXML->Summary->Item as $summaryItem) {
                    ...
                    $propertyValue = $summaryItem->_obfuscated_76616C2D737472696E67_;
                    switch ($propertyName) {
                        case "title":
                            $docProps->setTitle(trim($propertyValue));
                            break;
        ...
        foreach ($gnmXML->Sheets->Sheet as $sheet) {
            ...
            if (!$this->readDataOnly && isset($sheet->PrintInformation) && isset($sheet->PrintInformation->Margins)) {
                    ...
                    if (!$this->readDataOnly || PHPExcel_Shared_Date::isDateTimeFormatCode((string) $styleAttributes["Format"])) {
                        ...
                        if (!$this->readDataOnly) {
                            ...
                            if ($RGB != "000000" || $shade != "0") {
                                ...
                                $styleArray["fill"]["color"]["rgb"] = $styleArray["fill"]["startcolor"]["rgb"];
                            ...
                            if (isset($styleRegion->Style->StyleBorder)) {
                                ...
                                if (isset($styleRegion->Style->StyleBorder->Diagonal) && isset($styleRegion->Style->StyleBorder->_obfuscated_5265762D446961676F6E616C_)) {
                                    ...
                                    if (isset($styleRegion->Style->StyleBorder->Diagonal)) {
                                        ...
                                        if (isset($styleRegion->Style->StyleBorder->_obfuscated_5265762D446961676F6E616C_)) {
                                            $styleArray["borders"]["diagonal"] = self::parseBorderAttributes($styleRegion->Style->StyleBorder->_obfuscated_5265762D446961676F6E616C_->attributes());
            ...
            if (!$this->readDataOnly && isset($sheet->Cols)) {
                ...
                foreach ($sheet->Cols->ColInfo as $columnOverride) {
                    ...
                    for ($columnCount = isset($columnAttributes["Count"]) ? $columnAttributes["Count"] : 1; $c < $column; $c++) {
