    ...
    public function save($pFilename = NULL)
    {
        if ($this->spreadSheet !== NULL) {
            ...
            for ($i = 0; $i < $this->spreadSheet->getSheetCount(); $i++) {
                ...
                if (0 < count($this->spreadSheet->getSheet($i)->getComments())) {
                ...
                if (0 < count($this->spreadSheet->getSheet($i)->getHeaderFooter()->getImages())) {
