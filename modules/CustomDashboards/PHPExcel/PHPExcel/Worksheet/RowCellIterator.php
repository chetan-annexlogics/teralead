...
class PHPExcel_Worksheet_RowCellIterator extends PHPExcel_Worksheet_CellIterator implements Iterator
{
    ...
    public function seek($column = "A")
    {
        ...
        if ($column < $this->startColumn || $this->endColumn < $column) {
    ...
    public function prev()
    {
        ...
        do {
            $this->position--;
        } while ($this->onlyExistingCells && !$this->subject->cellExistsByColumnAndRow($this->position, $this->rowIndex) && $this->startColumn <= $this->position);
    }
    /**
    ...
    protected function adjustForExistingOnlyRange()
    {
        if ($this->onlyExistingCells) {
            ...
            while (!$this->subject->cellExistsByColumnAndRow($this->endColumn, $this->rowIndex) && $this->startColumn <= $this->endColumn) {
                $this->endColumn--;
            }
            if ($this->endColumn < $this->startColumn) {
                throw new PHPExcel_Exception("No cells exist within the specified range");
