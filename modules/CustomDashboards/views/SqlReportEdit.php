...
class CustomDashboards_SqlReportEdit_View extends Vtiger_Edit_View
{
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("libraries.jquery.ckeditor.ckeditor","libraries.jquery.ckeditor.adapters.jquery","modules.Vtiger.resources.CkEditor","modules.CustomDashboards.resources.Edit", "modules.CustomDashboards.resources.Edit1", "modules.CustomDashboards.resources.Edit2", "modules." . $moduleName . ".resources.SqlReportEdit", "modules." . $moduleName . ".resources.SqlReportEdit1", "modules." . $moduleName . ".resources.SqlReportEdit2", "~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.CustomDashboards.resources.CkEditor");
