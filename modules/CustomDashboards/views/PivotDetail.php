...
class CustomDashboards_PivotDetail_View extends Vtiger_Index_View
{
    ...
    public function preProcess(Vtiger_Request $request)
    {
        ...
        $reportPivotModel = CustomDashboards_Pivot_Model::getInstanceById($reportModel);
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~/layouts/v7/modules/CustomDashboards/resources/jbPivot/jbPivot.css", "~/layouts/v7/modules/CustomDashboards/resources/exportPivot/orb.css", "~layouts/v7/modules/CustomDashboards/resources/styleCustomDashboard.css");
