...
class CustomDashboards_ChartDetail_View extends Vtiger_Index_View
{
    ...
    public function preProcess(Vtiger_Request $request)
    {
        ...
        $this->record = $detailViewModel = CustomDashboards_DetailView_Model::getInstance($moduleName, $recordId);
		...
		$viewer->assign("VIEW", 'ChartDetail');
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("modules.Vtiger.resources.Detail", "modules.Vtiger.resources.dashboards.Widget", "modules." . $moduleName . ".resources.Detail", "modules." . $moduleName . ".resources.Edit", "modules." . $moduleName . ".resources.Edit3", "modules." . $moduleName . ".resources.ChartEdit", "modules." . $moduleName . ".resources.ChartEdit2", "modules." . $moduleName . ".resources.ChartEdit3", "modules." . $moduleName . ".resources.ChartDetail", "~/libraries/jquery/gridster/jquery.gridster.min.js", "~/layouts/v7/modules/CustomDashboards/resources/gridstack/lodash.min.js", "~/layouts/v7/modules/CustomDashboards/resources/gridstack/gridstack.min.js", "~/layouts/v7/modules/CustomDashboards/resources/gridstack/gridstack.jQueryUI.min.js", "~/libraries/jquery/jqplot/jquery.jqplot.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.canvasTextRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.pieRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.barRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.categoryAxisRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.pointLabels.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.canvasAxisLabelRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.funnelRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.barRenderer.min.js", "~/libraries/jquery/jqplot/plugins/jqplot.logAxisRenderer.min.js", "~/libraries/jquery/VtJqplotInterface.js", "~/libraries/jquery/vtchart.js", "~/layouts/v7/modules/CustomDashboards/resources/CustomDashboardsDashBoard.js", "~/layouts/v7/modules/CustomDashboards/resources/CustomDashboardsButtonDashBoard.js");
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $headerCss = array("~libraries/jquery/jqplot/jquery.jqplot.min.css", "~layouts/v7/modules/CustomDashboards/resources/styleCustomDashboard.css", "~/layouts/v7/modules/CustomDashboards/resources/gridstack/gridstack.min.css", "~/layouts/v7/modules/CustomDashboards/resources/gridstack/gridstack-extra.min.css");
