...
class CustomDashboards_Edit_View extends Vtiger_Edit_View
{
    ...
    public function checkPermission(Vtiger_Request $request)
    {
        ...
        $recordModel = CustomDashboards_Record_Model::getInstanceById($request->get("record"));
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $jsFileNames = array("modules." . $moduleName . ".resources.Edit1", "modules." . $moduleName . ".resources.Edit2", "modules." . $moduleName . ".resources.Edit3", "~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.CustomDashboards.resources.CkEditor");
        $jsScriptInstances = $this->checkAndConvertJsScripts($jsFileNames);
        $headerScriptInstances = array_merge($headerScriptInstances, $jsScriptInstances);
