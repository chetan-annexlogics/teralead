...
class CustomDashboards_PivotEdit_View extends Vtiger_Edit_View
{
    ...
    public function step1(Vtiger_Request $request)
    {
        ...
        $relatedModules = $reportModel->getCustomDashboardRelatedModules();
        ...
        $viewer->assign("SCHEDULEDREPORTS", $reportModel->getScheduledCustomDashboard());
    ...
    public function step3(Vtiger_request $request)
    {
        ...
        $pivotModel = CustomDashboards_Pivot_Model::getInstanceById($reportModel);
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("libraries.jquery.ckeditor.ckeditor","libraries.jquery.ckeditor.adapters.jquery","modules.Vtiger.resources.CkEditor","~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.CustomDashboards.resources.Edit", "modules.CustomDashboards.resources.Edit1", "modules.CustomDashboards.resources.Edit2", "modules.CustomDashboards.resources.Edit3", "modules." . $moduleName . ".resources.ChartEdit3", "modules." . $moduleName . ".resources.PivotEdit", "modules." . $moduleName . ".resources.PivotEdit1", "modules." . $moduleName . ".resources.PivotEdit2", "modules." . $moduleName . ".resources.PivotEdit3", "modules." . $moduleName . ".resources.PivotEdit4", "modules.CustomDashboards.resources.CkEditor");
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $cssFileNames = array("~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.css", "~layouts/v7/modules/CustomDashboards/resources/styleCustomDashboard.css");
