...
class CustomDashboards_List_View extends Vtiger_Index_View
{
    ...
    public function initializeListViewContents(Vtiger_Request $request)
    {
        ...
        if (!$this->listViewEntries) {
            ...
            foreach ($this->listViewEntries as $key => $recordModel) {
                ...
                $scheduleRecord = $recordModel->getScheduledCustomDashboard();
    ...
    public function getHeaderCss(Vtiger_Request $request)
    {
        ...
        $cssFileNames = array("~layouts/" . Vtiger_Viewer::getDefaultLayoutName() . "/lib/jquery/perfect-scrollbar/css/perfect-scrollbar.css", "~layouts/v7/modules/CustomDashboards/resources/styleCustomDashboard.css", "~layouts/v7/modules/CustomDashboards/resources/List.css");
