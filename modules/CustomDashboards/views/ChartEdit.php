...
class CustomDashboards_ChartEdit_View extends Vtiger_Edit_View
{
    ...
    public function step3(Vtiger_request $request)
    {
        ...
        $chartModel = CustomDashboards_Chart_Model::getInstanceById($reportModel);
    ...
    public function getHeaderScripts(Vtiger_Request $request)
    {
        ...
        $moduleName = $request->getModule();
        $jsFileNames = array("libraries.jquery.ckeditor.ckeditor","libraries.jquery.ckeditor.adapters.jquery","modules.Vtiger.resources.CkEditor","~libraries/jquery/jquery.datepick.package-4.1.0/jquery.datepick.js", "modules.CustomDashboards.resources.Edit", "modules.CustomDashboards.resources.Edit1", "modules.CustomDashboards.resources.Edit2", "modules.CustomDashboards.resources.Edit3", "modules." . $moduleName . ".resources.ChartEdit", "modules." . $moduleName . ".resources.ChartEdit1", "modules." . $moduleName . ".resources.ChartEdit2", "modules." . $moduleName . ".resources.ChartEdit3", "modules.CustomDashboards.resources.CkEditor");
