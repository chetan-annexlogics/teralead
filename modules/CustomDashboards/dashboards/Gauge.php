...
class CustomDashboards_Gauge_Dashboard extends Vtiger_MiniList_Dashboard
{
    public function process(Vtiger_Request $request, $oldWidget = NULL)
    {
        ...
        $widget = CustomDashboards_Widget_Model::getHistoryWidget($linkId, $currentUser->getId(), $widgetId);
        if (!$data) {
