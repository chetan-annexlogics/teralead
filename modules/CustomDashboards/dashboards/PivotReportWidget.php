...
class CustomDashboards_PivotReportWidget_Dashboard extends Vtiger_IndexAjax_View
{
    public function process(Vtiger_Request $request)
    {
        ...
        $widget = CustomDashboards_Widget_Model::getInstanceWithReportId($record, $tabId);
