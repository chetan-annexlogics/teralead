...
/**
 * Class CRMManager_Uninstall_View
 */
class CRMManager_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_crmmanagercf table
        echo "&nbsp;&nbsp;- Delete vtiger_crmmanagercf table.";
        $result = $adb->pquery("DROP TABLE vtiger_crmmanagercf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_crmmanager table
        echo "&nbsp;&nbsp;- Delete vtiger_crmmanager table.";
        $result = $adb->pquery("DROP TABLE vtiger_crmmanager");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
