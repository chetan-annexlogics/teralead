...
class CRMManager extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_crmmanager';
	var $table_index= 'crmmanagerid';
	var $related_tables = Array ('vtiger_crmmanagercf' => Array ( 'crmmanagerid', 'vtiger_crmmanager', 'crmmanagerid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_crmmanagercf', 'crmmanagerid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_crmmanager', 'vtiger_crmmanagercf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_crmmanager' => 'crmmanagerid',
		'vtiger_crmmanagercf'=>'crmmanagerid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_crmmanager, vtiger_users,
                ...
                vtiger_crmmanager.crmmanagerid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_crmmanager.crmmanagerid = $id AND
