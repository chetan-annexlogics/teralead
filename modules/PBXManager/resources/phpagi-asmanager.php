 ...
 * 
 * 
 * @copyright CodeStormS
 * @author Elios Maca Eliosmaca1@gmail.com
 * @website https://codestorms.com
 * @Fiverr https://www.fiverr.com/codestorms
 *
 *  
 **/
  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function AGI_AsteriskManager($config=NULL, $optconfig=array())
    {
      ...
      if(!isset($this->config['asmanager']['server'])) $this->config['asmanager']['server'] = '64.227.10.156';
      ...
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = 'Gyv6h/REM+AR';
    }
   /**
    * Send a request
    *
