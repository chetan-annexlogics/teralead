...
class PBXManager_PBXManager_Connector {
    ...
    //$serviceURL .= '/makecall?event=OutgoingCall&';
        ...
        $serviceURL .= 'record_id='. urlencode($record). '&';
        $serviceURL .= 'get_url='. urlencode($site_URL). '&';
        $serviceURL .= 'get_ip='. urlencode($getIP);
