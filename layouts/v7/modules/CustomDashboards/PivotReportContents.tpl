...
<script type="text/javascript" src="{$SITE_URL}/layouts/v7/modules/CustomDashboards/resources/exportPivot/react-0.12.2.min.js"></script>
<script type="text/javascript" src="{$SITE_URL}/layouts/v7/modules/CustomDashboards/resources/exportPivot/orb.js"></script>
{$DATA['export']}

<script src="{$SITE_URL}/layouts/v7/modules/CustomDashboards/resources/jbPivot/jbPivot.min.js"></script>
{$DATA['pivot']}
