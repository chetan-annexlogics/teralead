...
{strip}
    ...
    <div id="listview-actions" class="listview-actions-container">
        ...
        <div class = "row">
            ...
            <div class="btn-group listViewActionsContainer" role="group" aria-label="...">
                {if $deleteAction}
                    <button type="button" class="btn btn-default" id="{$MODULE}_listView_massAction_LBL_MOVE_REPORT" 
                            onclick='CustomDashboards_List_Js.massMove("index.php?module=CustomDashboards&view=MoveReports")' title="{vtranslate('LBL_MOVE_REPORT', $MODULE)}" disabled="disabled">
            ...
            <a href="index.php?module=CustomDashboards&view=DashBoard" class="btn btn-default">Dashboards</a>
            <span class="btn-group"><button class="btn btn-default dropdown-toggle module-buttons" data-toggle="dropdown" id="CustomDashboards_listView_basicAction_Add" style="margin: 0;border: 1px solid var(--btn-border-color)!important"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Report&nbsp;<i class="caret icon-white"></i></button><ul class="dropdown-menu"><li id="CustomDashboards_listView_basicAction_LBL_DETAIL_REPORT" data-edition-disable="" data-edition-message=""><a onclick="CustomDashboards_List_Js.addReport(&quot;index.php?module=CustomDashboards&amp;view=Edit&quot;);"><i class="vicon-detailreport" style="font-size:13px;"></i>&nbsp; Detail Report</a></li><li id="CustomDashboards_listView_basicAction_LBL_CHARTS" data-edition-disable="" data-edition-message=""><a onclick="CustomDashboards_List_Js.addReport(&quot;index.php?module=CustomDashboards&amp;view=ChartEdit&quot;);"><i class="fas fa-chart-pie" style="font-size:13px;"></i>&nbsp; Charts</a></li><li id="CustomDashboards_listView_basicAction_LBL_PIVOT" data-edition-disable="" data-edition-message=""><a onclick="CustomDashboards_List_Js.addReport(&quot;index.php?module=CustomDashboards&amp;view=PivotEdit&quot;);"><i class="fa fa-table" style="font-size:13px;"></i>&nbsp; Pivot</a></li></ul></span>
            </div>
            <div class='col-md-4'>
