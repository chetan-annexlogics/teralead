						...
						<td width="25%">
							...
							{if $SELECTABLE_WIDGETS['other']}
								{foreach from=$SELECTABLE_WIDGETS['other'] item=WIDGET}
									{if $WIDGET->getName() != 'MiniList' && $MODULE_NAME == 'CustomDashboards'}
										<div class="chartReport">
											<a id="addWidget" class="filterName listViewFilterElipsis" name="{$WIDGET->getName()}" onclick="CustomDashboards_DashBoard_Js.addWidget(this, '{$WIDGET->getUrl()}')" href="javascript:void(0);"
									...
									{else}
										<div class="chartReport">
											<a id="addWidget" class="filterName listViewFilterElipsis" name="{$WIDGET->getName()}" onclick="CustomDashboards_DashBoard_Js.addMiniListWidget(this, '{$WIDGET->getUrl()}')" href="javascript:void(0);"
												...
												{if $WIDGET->get('folderid') eq $FOLDERID}
													...
													{else}
														...
														<li style="font-size:12px;" class="chartReport {if $WIDGET->get('is_show') == true}hide{/if}" data-id="{$WIDGET->get('reportid')}">
															...
															<a id="addWidget" class="filterName listViewFilterElipsis" onclick="CustomDashboards_DashBoard_Js.addWidget(this, '{$WIDGET->getUrl()}')" href="javascript:void(0);"
