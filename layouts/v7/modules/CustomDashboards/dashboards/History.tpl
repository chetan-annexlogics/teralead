...
{strip}
    ...
    <div class="dashboardWidgetContent" style="padding:unset;text-align: left;float:left;{if $WIDGET_COLOR}background-color:{$WIDGET_COLOR}{/if}">
    ...
    <div class="widgeticons dashBoardWidgetFooter panel_footer sticky_footer" style="top: 100%;text-align: left;display: none">
        <div class="filterContainer boxSizingBorderBox" style="background: whitesmoke">
            <div style="text-align: right;color: crimson" class="col-lg-12 pull-right"><a data-hide="hide" onclick="CustomDashboards_DashBoard_Js.registerFilterInitiater(this)">Close</a></div>
