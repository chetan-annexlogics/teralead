					...
					<table class="table no-border">
						...
						{if $WIDGET_MODE neq 'Settings'}
							...
							{if $WIDGET_NAME eq 'MiniList'}
								...
								<tr>
									<td class="col-lg-1"></td>
									<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_FIELD_ORDER','CustomDashboards')}</label></td>
									<td class="fieldValue col-lg-5">
								...
								<tr>
									<td class="col-lg-1"></td>
									<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_FIELD_ORDER_1','CustomDashboards')}</label></td>
									<td class="fieldValue col-lg-5">
										<div style="display: inline-block;width: 100%">
						...
						{if $WIDGET_NAME eq 'Gauge'}
							<tr>
								<td class="col-lg-1"></td>
								<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_TARGET_REPORT','CustomDashboards')}</label></td>
								<td class="fieldValue col-lg-5">
							...
							<tr>
								<td class="col-lg-1"></td>
								<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_DATA','CustomDashboards')}</label></td>
								<td class="fieldValue col-lg-5">
						...
						<tr>
							<td class="col-lg-1"></td>
							<td class="fieldLabel col-lg-4"><label id="pick_color" class="pull-right {if $WIDGET_NAME neq 'KeyMetrics'}hideByStep{/if}">{vtranslate('LBL_PICK_COLOR','CustomDashboards')}</label></td>
							<td class="fieldValue col-lg-5">
								<div {if $WIDGET_NAME neq 'KeyMetrics'}class="hideByStep"{/if}  id="pick_color">
									...
									<div class="div-inline">
										...
										<div class="color-box" data-value="#212121" style="background: #212121"></div>
									</div>
									<div class="div-inline">
										<div class="color-box {if $WIDGET_FORM  eq 'Create'}selected-color-box{/if}" data-value="#FFFFFF" style="background: #FFFFFF"></div>
										<div class="color-box" data-value="#000000" style="background: #000000"></div>
									</div>
									<input type="hidden" name="selectedColor" id="selectedColor" value="{if $WIDGET}{$WIDGET->get('pick_color')}{/if}">
									<br>
									<center><label><a onclick="CustomDashboards_DashBoard_Js.registerEventShowCustomColor()">Add custom color</a></label></center>
								</div>
							</td>
							<td class="col-lg-4"></td>
						</tr>
						<tr>
							<td class="col-lg-1"></td>
							<td class="fieldLabel col-lg-4"><label id="widget_color" class="pull-right {if $WIDGET_NAME neq 'KeyMetrics'}hideByStep{/if}">{vtranslate('LBL_PICK_WIDGET_COLOR','CustomDashboards')}</label></td>
							<td class="fieldValue col-lg-5">
								<div {if $WIDGET_NAME neq 'KeyMetrics'}class="hideByStep"{/if}  id="widget_color">
									<div class="div-inline">
										<div class="color-box-widget" data-value="#8bc34a" style="background: #8bc34a"></div>
										<div class="color-box-widget" data-value="#ffeb3b" style="background: #ffeb3b"></div>
										<div class="color-box-widget" data-value="#ffc107" style="background: #ffc107"></div>
										<div class="color-box-widget" data-value="#ff5722" style="background: #ff5722"></div>
										<div class="color-box-widget" data-value="#e91e63" style="background: #e91e63"></div>

										<div class="color-box-widget" data-value="#259b24" style="background: #259b24"></div>
										<div class="color-box-widget" data-value="#cddc39" style="background: #cddc39"></div>
										<div class="color-box-widget" data-value="#ff9800" style="background: #ff9800"></div>
										<div class="color-box-widget" data-value="#e51c23" style="background: #e51c23"></div>
										<div class="color-box-widget" data-value="#9c27b0" style="background: #9c27b0"></div>
									</div>
									<div class="div-inline">
										<div class="color-box-widget" data-value="#4b0082" style="background: #4b0082"></div>
										<div class="color-box-widget" data-value="#03a9f4" style="background: #03a9f4"></div>
										<div class="color-box-widget" data-value="#00bcd4" style="background: #00bcd4"></div>
										<div class="color-box-widget" data-value="#9e9e9e" style="background: #9e9e9e"></div>
										<div class="color-box-widget" data-value="#607d8b" style="background: #607d8b"></div>

										<div class="color-box-widget" data-value="#673ab7" style="background: #673ab7"></div>
										<div class="color-box-widget" data-value="#5677fc" style="background: #5677fc"></div>
										<div class="color-box-widget" data-value="#009688" style="background: #009688"></div>
										<div class="color-box-widget" data-value="#795548" style="background: #795548"></div>
										<div class="color-box-widget" data-value="#212121" style="background: #212121"></div>
									</div>
									<div class="div-inline">
										<div class="color-box-widget {if $WIDGET_FORM  eq 'Create'}selected-color-box{/if}" data-value="#FFFFFF" style="background: #FFFFFF"></div>
										<div class="color-box-widget" data-value="#000000" style="background: #000000"></div>
									</div>
									<input type="hidden" name="widgetcolor" id="widgetcolor" value="{if $WIDGET}{$WIDGET->get('widget_color')}{/if}">
									<br>
									<center><label><a onclick="CustomDashboards_DashBoard_Js.registerEventShowWidgetCustomColor()">Add custom color</a></label></center>
								</div>
							</td>
							<td class="col-lg-4"></td>
						</tr>
						...
						<tr>
							<td class="col-lg-1"></td>
							<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_TITLE','CustomDashboards')}</label></td>
							<td class="fieldValue col-lg-5" >
						...
						{if $WIDGET_NAME eq 'Gauge'}
							<tr>
								<td class="col-lg-1"></td>
								<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_SUB_TITLE','CustomDashboards')}</label></td>
								<td class="fieldValue col-lg-5" >
									<input type="text" class="inputElement" name="sub_title" value="{if $WIDGET}{CustomDashboards_Gauge_Model::getValueByName($WIDGET,'sub_title')}{/if}" placeholder="Sub title (optional)"/>
								</td>
								<td class="col-lg-4"></td>
							</tr>
						{/if}
						<tr>
							<td class="col-lg-1"></td>
							<td class="fieldLabel col-lg-4"><label id="label-picklist-color" class="pull-right hideByStep">{vtranslate('LBL_PICK_COLOR','CustomDashboards')}</label></td>
							<td class="fieldValue col-lg-5" >
								<div id="div-picklist-color" class="hideByStep">
									<div class="colorPicker">
										...
										<center><label><a onclick="CustomDashboards_DashBoard_Js.registerEventShowNomalColor()">Go back</a></label></center>
									</div>

								</div>
								<div id="div-widget-picklist-color" class="hideByStep">
									<div class="widgetcolorPicker">
										<input type="hidden" name="widgetcolor" id="widgetcolor" value="{if $WIDGET}{$WIDGET->get('pick_color')}{/if}">
										<div class="widgetcolorPicker" id="collorpicker_272"
											 style="position: relative; display: block;">
											<div class="colorpicker_color" style="background-color: rgb(255, 0, 255);">
												<div>
													<div style="left: 117px; top: 24px;"></div>
									...
									<center><label><a onclick="CustomDashboards_DashBoard_Js.registerEventShowWidgetColor()">Go back</a></label></center>
								</div>
						...
						{if $WIDGET_NAME eq 'KeyMetrics'}
							<tr>
								<td class="col-lg-1"></td>
								<td class="fieldLabel col-lg-4"><label class="pull-right">{vtranslate('LBL_SHOW_EMPTY_RECORD','CustomDashboards')}</label></td>
						...
						<tr>
							<td class="col-lg-1"></td>
							<td class="fieldLabel col-lg-4"><label id="refresh_time" class="pull-right{if $WIDGET_MODE neq 'Settings'}  hideByStep" {else}"{/if}">{vtranslate('LBL_REFRESH_TIME','CustomDashboards')}</label></td>
							<td class="fieldValue col-lg-5">
                        ...
                        {if $WIDGET_MODE neq 'Settings' || $WIDGET_NAME eq 'MiniList' || $WIDGET_NAME eq 'Gauge'}
							{if $WIDGET_NAME eq 'MiniList'}
								<tr>
									<td class="col-lg-1"></td>
									<td class="fieldLabel col-lg-4"><label id="min-height-label" class="pull-right {if $WIDGET_MODE neq 'Settings'} hideByStep {/if}">{vtranslate('LBL_MIN_HEIGHT','CustomDashboards')}</label></td>
									<td class="fieldValue col-lg-5" >
								...
								<tr>
									<td class="col-lg-1"></td>
									<td class="fieldLabel col-lg-4"><label id="max-height-label" class="pull-right {if $WIDGET_MODE neq 'Settings'} hideByStep {/if}>">{vtranslate('LBL_MAX_HEIGHT','CustomDashboards')}</label></td>
									<td class="fieldValue col-lg-5" >
							...
							{if $WIDGET_FORM neq 'Create'}
								<tr>
									<td class="col-lg-1"></td>
									<td class="fieldLabel col-lg-4"><label id="assigned-to-label" class="pull-right {if $WIDGET_MODE neq 'Settings'} hideByStep {/if}>">{vtranslate('LBL_ASSIGNED_TO','CustomDashboards')}</label></td>
									<td class="fieldValue col-lg-5" >
										<div id="assigned-to" {if $WIDGET_MODE neq 'Settings'}class="hideByStep"{/if}>
											...
											<select class="inputElement select2" name="filter_assignedto">
												...
												<option value="0" {if $ASSIGNED_TO_VALUE eq '0'} selected {/if}>{vtranslate('Logged in user','CustomDashboards')}</option>
								...
								<tr>
									<td class="col-lg-1"></td>
									<td class="fieldLabel col-lg-4"><label id="assigned-to-label" class="pull-right {if $WIDGET_MODE neq 'Settings'} hideByStep {/if}>">{vtranslate('Created By','CustomDashboards')}</label></td>
									<td class="fieldValue col-lg-5" >
										<div id="created-by" {if $WIDGET_MODE neq 'Settings'}class="hideByStep"{/if}>
											...
											<select class="inputElement select2" name="filter_createdby">
												<option value="">{vtranslate('LBL_SELECT_OPTION','Vtiger')}</option>
												<option value="0">{vtranslate('Logged in user','CustomDashboards')}</option>
												<optgroup label="{vtranslate('LBL_USERS')}">
													{foreach key=OWNER_ID item=OWNER_NAME from=$ALL_ACTIVEUSER_LIST}
