...
Vtiger_Detail_Js("CustomDashboards_Detail_Js",{},{
	...
	calculateValues : function(){
        ...
        this.advanceFilterInstance = CustomDashboards_AdvanceFilter_Js.getInstance(jQuery('.filterContainer:not(#conditionClone > .filterContainer)',container),false);
    ...
    registerEventsForActions : function() {
      ...
      jQuery('.reportActions').click(function(e){
        ...
        if(type.indexOf("Print") != -1 || type.indexOf("PrintV2") != -1){
	...
	registerEvents : function(){
		...
		var container = this.getContentHolder();
		this.advanceFilterInstance = CustomDashboards_AdvanceFilter_Js.getInstance(jQuery('.filterContainer:not(#conditionClone > .filterContainer)',container),true);
