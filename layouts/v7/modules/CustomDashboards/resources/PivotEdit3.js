CustomDashboards_Edit1_Js("CustomDashboards_PivotEdit3_Js",{
    ...
    initSelectValues : function() {
        ...
        if(groupByFieldValueRows) {
            ...
            CustomDashboards_PivotEdit3_Js.updateSelectElement(groupByFieldValueRows,groupByFieldColumns);
        }
        if(groupByFieldValueColumns) {
            groupByFieldValueColumns = JSON.parse(groupByFieldValueColumns);
            CustomDashboards_PivotEdit3_Js.updateSelectElement(groupByFieldValueColumns,groupByFieldRows);
        }
        if(dataFieldsValue) {
