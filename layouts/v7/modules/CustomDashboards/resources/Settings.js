 ...
 * //ContentNop
 * ****************************************************************************** */
Vtiger_Index_Js("CustomDashboards_Settings_Js",{
    instance:false,
    getInstance: function(){
        if(CustomDashboards_Settings_Js.instance == false){
            var instance = new CustomDashboards_Settings_Js();
            CustomDashboards_Settings_Js.instance = instance;
            return instance;
        }
        return CustomDashboards_Settings_Js.instance;
    }
},{
                    ...
                    function(err, data) {
                        ...
                        if(data) {
                            ...
                            if(message !='Valid License') {
                                ...
                                document.location.href="index.php?module=CustomDashboards&parent=Settings&view=Settings&mode=step3";
                            }
                        }
                    },
                    function(error) {
        ...
        jQuery(".installationContents").find('[name="btnFinish"]').click(function() {
            ...
            app.request.post({'data':params}).then(
                function (err, data) {
                    app.helper.hideProgress();
                    if(err === null) {
                        document.location.href = "index.php?module=CustomDashboards&parent=Settings&view=Settings";
                    }
                },
                function (error) {
                    app.helper.hideProgress();
    ...
    registerEnableModuleEvent:function() {
        jQuery('.summaryWidgetContainer').find('#enable_module').change(function(e) {
            ...
            var value=0;
            var text="CustomDashboards Disabled";
            if(element.checked) {
                value=1;
                text = "CustomDashboards Enabled";
            }
            var params = {};
            params.action = 'ActionAjax';
            params.module = 'CustomDashboards';
            params.value = value;
