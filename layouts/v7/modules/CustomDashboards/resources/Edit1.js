 ...
 * All Rights Reserved.
 *************************************************************************************/
CustomDashboards_Edit_Js("CustomDashboards_Edit1_Js",{},{
	...
	loadRelatedModules : function(primaryModule){
		...
		for(var key in relatedModulesMapping) {
			...
			if(relatedModulesMapping.hasOwnProperty(key)) {
				if(primaryModule=="SMPItems" && (key=="Products" || key =="Services")){
					continue;
				}
    ...
    registerSecondaryModuleChangeEvent : function(){
        ...
        jQuery('#secondary_module').on('change',function(e){
            ...
            if(secondaryModule){
                if($.inArray("SMPItems",secondaryModule)!=-1){
    ...
    getckEditorInstance : function(){
        if(this.ckEditorInstance == false){
            this.ckEditorInstance = new CustomDashboards_CkEditor_Js();
        }
	...
	registerEvents : function(){
        ...
        //NOTE: not allow select product and services when it have SMPItems
        ...
        if(secondaryModule && step == 1){
        	if(jQuery('#primary_module').val()=="SMPItems"){
