                ...
                {foreach item=PRIMARY_FIELD_BLOCK  from=$FIELD_SETTING['primary_value_setting']}
                    <div class="kanbanBox">
                        ...
                        <div class="kbBoxHeader" style="background:{$instanceColor}">
                            ...
                            <span class="kbTopIcon pull-right">
                                <a class="removeThisBox" data-box-name = "{$PRIMARY_FIELD_BLOCK}"><img src="layouts/v7/modules/VTDevKBView/images/close.png" alt="Close"/></a>
                            </span>
                        </div>
                        <div class="kbBoxContent">
                                ...
                                <div class="kbBoxTask" {if !empty($BACKGROUND_CARD)}style="background:{$BACKGROUND_CARD} "{/if}>
                                    ...
                                    <div class="kbTaskHeader">
                                        ...
                                        <span class="pull-right kbEditIcon">
                                            <a href="javascript:void(0)" data-url="index.php?module=VTDevKBView&view=QuickEditAjax&record={$RECORD_MODEL['RECORD']->getId()}&source_module={$KANBAN_SOURCE_MODULE}" title="Edit" class="fa fa-pencil alignMiddle kbQuickEdit"></a>
                                        </span>
                                        <span class="kbEyeIcon pull-right">
                                            <a href="index.php?module={$KANBAN_SOURCE_MODULE}&view=Detail&record={$RECORD_MODEL['RECORD']->getId()}&cvid={$CV_ID}" title="{vtranslate('LBL_GO_TO_DETAIL_VIEW', 'VTDevKBView')}"><img src="layouts/v7/modules/VTDevKBView/images/eye.png" alt="Show more"/></a>
                                        </span>
                            ...
                            {/foreach}
                            <div class="addBtn">
                                <a href="javascript:void(0)" data-url="index.php?module=VTDevKBView&view=QuickEditAjax&primaryFieldName={$PRIMARY_FIELD_SELECT}&primaryFieldValue={$PRIMARY_FIELD_BLOCK}&source_module={$KANBAN_SOURCE_MODULE}" class="kbQuickCreate">
                                    <img src="layouts/v7/modules/VTDevKBView/images/plus.png" alt="Add"/><span style="margin-left: 8px">Add New</span>
                                </a>
                            </div>
                        </div>
                    </div>
