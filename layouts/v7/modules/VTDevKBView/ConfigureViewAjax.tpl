...
<div class="modal-dialog">
    <div class="modal-content">
        <form class="form-horizontal" id="VTDevKBConfigure" name="VTDevKBConfigure" method="post" action="index.php">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="save_vtdevkbview_setting" type="button"><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
            </div>
        </form>
    </div>
</div>
