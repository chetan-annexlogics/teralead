<?php /* Smarty version Smarty-3.1.7, created on 2024-01-03 14:19:24
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/Step1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78447877565956cec685932-81845790%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a19d942d7cac82a732a8a2cf498a3e4c8aad7b7' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/Step1.tpl',
      1 => 1704289893,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '78447877565956cec685932-81845790',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_65956cec6d361',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_65956cec6d361')) {function content_65956cec6d361($_smarty_tpl) {?>
...
<?php }elseif($_smarty_tpl->tpl_vars['REPORT_TYPE']->value=='PivotEdit'){?>
    <?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("EditPivotHeader.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<?php }elseif($_smarty_tpl->tpl_vars['REPORT_TYPE']->value=='SqlReportEdit'){?>
    <?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("SqlReportEditHeader.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" />
        <input type=hidden id="relatedModules" data-value='<?php echo html_entity_decode(ZEND_JSON::encode($_smarty_tpl->tpl_vars['RELATED_MODULES']->value));?>
' />
...
" 
            ...
            <?php if ($_smarty_tpl->tpl_vars['TYPE']->value!='sql'){?>
                <div class="row">
                    <div class="form-group">
...
<span class="redColor">*</span></label>
                        <div class="col-lg-4">
                            <select class="select2-container select2 col-lg-12 inputElement" id="primary_module" name="primary_module" data-rule-required="true"
                                ...
                                <option value=""><?php echo vtranslate('SELECT_AN_OPTION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option>
...
">
                            <option data-member-type="ShareAll" value="ShareAll:1" <?php if ($_smarty_tpl->tpl_vars['SELECTED_MEMBERS_SHARE_ALL']->value=='1'){?> selected="selected" <?php }?>>Everyone</option>
