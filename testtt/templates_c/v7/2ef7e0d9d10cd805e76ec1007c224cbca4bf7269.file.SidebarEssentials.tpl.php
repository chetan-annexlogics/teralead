<?php /* Smarty version Smarty-3.1.7, created on 2024-01-03 13:51:54
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/partials/SidebarEssentials.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6696736536595667aa968b5-44096483%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ef7e0d9d10cd805e76ec1007c224cbca4bf7269' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/partials/SidebarEssentials.tpl',
      1 => 1704289893,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6696736536595667aa968b5-44096483',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6595667aaae11',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6595667aaae11')) {function content_6595667aaae11($_smarty_tpl) {?>
...
</h5><button id="createFilter" onclick='VReports_List_Js.triggerAddFolder("index.php?module=VReports&view=EditFolder");' class="btn btn-default pull-right sidebar-btn" title="<?php echo vtranslate('LBL_ADD_NEW_FOLDER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?><li style="font-size:12px;" class="listViewFilter <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['folderview']['iteration']>20){?> filterHidden hide<?php }?>" ><?php ob_start();?><?php echo vtranslate($_smarty_tpl->tpl_vars['FOLDER']->value->getName(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li><li style="font-size:12px;" class="listViewFilter" ><a href="#" class='filterName' data-filter-id="Public"><i class="fa fa-folder foldericon"></i>&nbsp;<?php echo vtranslate('LBL_PUBLIC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
.."><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['folderview']['iteration']>20){?><?php echo vtranslate('LBL_MORE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
