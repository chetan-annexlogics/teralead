<?php /* Smarty version Smarty-3.1.7, created on 2023-08-07 13:57:30
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/Comment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51158270364d0f84ad959e8-51388293%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a192f6ed7a98b50d7f1a2988d9ad5d623b080ec' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/Comment.tpl',
      1 => 1627027149,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '51158270364d0f84ad959e8-51388293',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_64d0f84ae46d0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_64d0f84ae46d0')) {function content_64d0f84ae46d0($_smarty_tpl) {?>
<?php $_smarty_tpl->tpl_vars["PRIVATE_COMMENT_MODULES"] = new Smarty_variable(Vtiger_Functions::getPrivateCommentModules(), null, 0);?><div class="commentDiv <?php if ($_smarty_tpl->tpl_vars['COMMENT']->value->get('is_private')){?>privateComment<?php }?>"><div class="singleComment"><input type="hidden" name="is_private" value="<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->get('is_private');?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CREATOR_NAME'] = new Smarty_variable($_tmp1, null, 0);?><div class="col-lg-2 recordImage commentInfoHeader" style ="width:50px; height:50px; font-size: 30px;" data-commentid="<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->getId();?>
" data-parentcommentid="<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->get('parent_comments');?>
" data-relatedto = "<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->get('related_to');?>
