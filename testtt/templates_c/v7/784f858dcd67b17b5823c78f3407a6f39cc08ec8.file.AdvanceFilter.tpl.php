<?php /* Smarty version Smarty-3.1.7, created on 2024-01-03 14:20:57
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/AdvanceFilter.tpl" */ ?>
<?php /*%%SmartyHeaderCode:130866713765956d49978e24-99897622%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '784f858dcd67b17b5823c78f3407a6f39cc08ec8' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/AdvanceFilter.tpl',
      1 => 1704289893,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '130866713765956d49978e24-99897622',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'CONDITION_INFO' => 0,
    'GROUP_CONDITION' => 0,
    'GROUP_PARENT_CONDITION' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_65956d4999ecf',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_65956d4999ecf')) {function content_65956d4999ecf($_smarty_tpl) {?>
<?php $_smarty_tpl->tpl_vars['ALL_CONDITION_CRITERIA'] = new Smarty_variable($_smarty_tpl->tpl_vars['ADVANCE_CRITERIA']->value[1], null, 0);?><?php $_smarty_tpl->tpl_vars['ANY_CONDITION_CRITERIA'] = new Smarty_variable($_smarty_tpl->tpl_vars['ADVANCE_CRITERIA']->value[2], null, 0);?><?php $_smarty_tpl->tpl_vars['GROUP_PARENT_CONDITION'] = new Smarty_variable($_smarty_tpl->tpl_vars['ADVANCE_CRITERIA']->value['groupParentCondition'], null, 0);?><?php if (empty($_smarty_tpl->tpl_vars['ALL_CONDITION_CRITERIA']->value)){?><?php $_smarty_tpl->tpl_vars['ALL_CONDITION_CRITERIA'] = new Smarty_variable(array(), null, 0);?><?php }?><?php if (empty($_smarty_tpl->tpl_vars['ANY_CONDITION_CRITERIA']->value)){?><?php $_smarty_tpl->tpl_vars['ANY_CONDITION_CRITERIA'] = new Smarty_variable(array(), null, 0);?><?php }?><div class="filterContainer filterElements filterConditionContainer filterConditionsDiv"><input type="hidden" name="date_filters" data-value='<?php echo Vtiger_Util_Helper::toSafeHTML(ZEND_JSON::encode($_smarty_tpl->tpl_vars['DATE_FILTERS']->value));?>
...
' /><div class="allConditionContainer conditionGroup contentsBackground" style="padding-bottom:15px;"><div class="header row-fluid" style="margin-bottom: 30px"><span class="col-lg-3 col-md-3"><strong><?php echo vtranslate('LBL_ALL_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong>&nbsp;&nbsp;(<?php echo vtranslate('LBL_ALL_CONDITIONS_DESC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
)</span><span class="col-lg-9 col-md-9 addCondition"><button type="button" class="button-header-vreport"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_CONDITION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></span></div><div class="contents"><div class="conditionList"><?php  $_smarty_tpl->tpl_vars['CONDITION_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['CONDITION_INFO']->_loop = false;
...
</div><div class="groupCondition"><?php $_smarty_tpl->tpl_vars['GROUP_CONDITION'] = new Smarty_variable($_smarty_tpl->tpl_vars['ALL_CONDITION_CRITERIA']->value['condition'], null, 0);?><?php if (empty($_smarty_tpl->tpl_vars['GROUP_CONDITION']->value)){?><?php $_smarty_tpl->tpl_vars['GROUP_CONDITION'] = new Smarty_variable("and", null, 0);?><?php }?><input type="hidden" name="condition" value="<?php echo $_smarty_tpl->tpl_vars['GROUP_CONDITION']->value;?>
" /></div></div></div><div class="anyConditionContainer conditionGroup contentsBackground"><div class="header row-fluid" style="margin-bottom: 30px"><span class="col-lg-3 col-md-3"><strong><?php echo vtranslate('LBL_ANY_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong>&nbsp;&nbsp;(<?php echo vtranslate('LBL_ANY_CONDITIONS_DESC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
)</span><span class="col-lg-9 col-md-9 addCondition"><button type="button" class="button-header-vreport"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_CONDITION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></span></div><div class="contents"><div class="conditionList"><?php  $_smarty_tpl->tpl_vars['CONDITION_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['CONDITION_INFO']->_loop = false;
...
</div></div></div></div><?php if ($_smarty_tpl->tpl_vars['GROUP_PARENT_CONDITION']->value!=''){?><div class="button-action" style="margin: 20px auto; width: 200px; display: inherit"><select class="group-condition select2" style="height: 30px;width: 70px"><option value="or" <?php if ($_smarty_tpl->tpl_vars['GROUP_PARENT_CONDITION']->value=='or'){?>selected="selected"<?php }?>><?php echo vtranslate('LBL_OR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option><option value="and" <?php if ($_smarty_tpl->tpl_vars['GROUP_PARENT_CONDITION']->value=='and'){?>selected="selected"<?php }?>><?php echo vtranslate('LBL_AND',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option></select><button class="btn btn-default deleteGroup" style="margin-left: 15px"><?php echo vtranslate('LBL_DELETE_GROUP',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></div><?php }?><?php }} ?>