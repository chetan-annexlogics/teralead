<?php /* Smarty version Smarty-3.1.7, created on 2024-01-03 14:19:24
         compiled from "/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/ScheduleReport.tpl" */ ?>
<?php /*%%SmartyHeaderCode:176989639565956cec6eb826-98173103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0deb969f0afb3de41489f2e5b38b2f890027da29' => 
    array (
      0 => '/home/customer/www/crm.teraleads.com/public_html/includes/runtime/../../layouts/v7/modules/VReports/ScheduleReport.tpl',
      1 => 1704289893,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '176989639565956cec6eb826-98173103',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_65956cec74785',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_65956cec74785')) {function content_65956cec74785($_smarty_tpl) {?>
...
" name="specificemails" data-validation-engine="validate[funcCall[Vtiger_MultiEmails_Validator_Js.invokeValidation]]"></input></div></div><div class='col-lg-12' id='div_from_address' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><?php echo vtranslate('FROM_ADDRESS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div><div class='col-lg-4'><input id="from_address" style="width: 281px !important;" class="col-lg-6 inputElement" type="text" value="<?php echo $_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('from_address');?>
" name="from_address"/></div></div><div class='col-lg-12' id='div_subject_mail' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><?php echo vtranslate('SUBJECT_MAIL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div><div class='col-lg-4'><input id="subject_mail" style="width: 281px !important;" class="col-lg-6 inputElement" type="text" value="<?php echo $_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('subject_mail');?>
" name="subject_mail"/><button type="button" id="selectEmailTemplate" class="btn btn-success pull-right" data-url="module=EmailTemplates&view=Popup">Select Email Template</button></div></div><div class='col-lg-12' id='div_content_mail' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><?php echo vtranslate('BODY_MAIL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div><div class='col-lg-4'><textarea id="content_mail" style="width: 100% !important; height: 100px; padding: 3px 8px" class="col-lg-12 inputElement" type="text" name="content_mail"><?php echo $_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('content_mail');?>
</textarea></div></div><div class='col-lg-12' id='div_signature_mail' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><?php echo vtranslate('Include Signature',$_smarty_tpl->tpl_vars['MODULE']->value);?>
<input class="pull-right" type="checkbox" name="signature" value="Yes" id="signature" <?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('signature')=='Yes'){?>checked="checked"<?php }?>/></div><div class='col-lg-4'><span id="span_signature_user" <?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('signature')!='Yes'){?>style="display: none" <?php }?>><select class="select2" id='signature_user' name='signature_user' style="width: 280px !important;"><?php  $_smarty_tpl->tpl_vars['USER_NAME'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['USER_NAME']->_loop = false;
 $_smarty_tpl->tpl_vars['USER_ID'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['ALL_ACTIVEUSER_LIST']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['USER_NAME']->key => $_smarty_tpl->tpl_vars['USER_NAME']->value){
$_smarty_tpl->tpl_vars['USER_NAME']->_loop = true;
...
" <?php if ($_smarty_tpl->tpl_vars['SCHEDULEDREPORTS']->value->get('signature_user')==$_smarty_tpl->tpl_vars['USER_ID']->value){?>selected="selected"<?php }?>> <?php echo $_smarty_tpl->tpl_vars['USER_NAME']->value;?>
 </option><?php } ?></select></span></div></div><?php if ($_smarty_tpl->tpl_vars['TYPE']->value!='Chart'){?><div class='col-lg-12' id='fileformat' style='padding:5px 0px 10px 0px;'><div class='col-lg-3' style='position:relative;top:5px;'><?php echo vtranslate('LBL_FILE_FORMAT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
